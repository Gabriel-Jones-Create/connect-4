 ...
 * Represents an agents movement strategy in the game including starting in the

 * center of the board and moving outwards unless it is a bad move, a move

 * allowing the opponent to win, not allowing the opponent to get three in a

 * row, and lastly if nothing else works, simply place the agent in a spot that

 * is not a bad move and the column is not full
